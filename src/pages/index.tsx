...
export default function Home() {
  ...
  return (
     ...
     <>
  <div className="mt-[300px] ml-[210px] text-5xl font-bold text-black">
    {" "}
  ...
  <div className="text-black  mt-[200px] ml-[210px]">
    {" "}
  ...
  <div className="w-[600px] h-[600px] mt-[-350px] ml-[1100px]">
