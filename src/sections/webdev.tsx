                        ...
                        <span className="flex">
                          ...
                          <span className="grow ms-6">
                            ...
                            <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-neutral-200">
                              ...
                              therefore very precise because of an{" "}
                      ...
                      >
                        <span className="flex">
                          ...
                          <span className="grow ms-6">
                            ...
                            <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-neutral-200">
                              This website was my old{" "}
                              <span className="text-blue-300 font-bold">
                                {" "}
                                Portfolio
                              </span>{" "}
                              created with HTML and CSS very basic
                            </span>
                          </span>
                        </span>
                      </button>
                      ...
                      >
                        <span className="flex">
                          ...
                          <span className="grow ms-6">
                            ...
                            <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-neutral-200">
                              This portfolio is of course also mine and was
                              created with Tailwind, TypeScript,{" "}
                              <span className="text-blue-300 font-bold">
                                {" "}
                                React{" "}
                              </span>
